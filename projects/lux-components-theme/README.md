...
| `.lux-card-scroll-content`           | Klasse für die lux-card, die den Card-Inhalt wieder innerhalb der Card scrollbar macht, statt ihn abzuschneiden (overflow: auto). Hinweis: luxStickyHeader funktioniert darin nicht.    |
