...
export class ComponentsOverviewNavigationService {
  ...
  private readonly components: DemoNavigationComponentEntry[] = [
    ...
    this.create('form', 'Datepicker'),
    this.create('form', 'Datetimepicker'),
    this.create('form', 'Timepicker', DemoMarkerType.New),
    this.create('form', 'File-Input'),
    this.create('form', 'File-List'),
    this.create('form', 'File-Upload'),
    this.create('form', 'Input'),
    this.create('form', 'Radio-Button'),
    this.create('form', 'Select', DemoMarkerType.Updated),
    this.create('form', 'Slider'),
    this.create('form', 'Textarea'),
    this.create('form', 'Toggle'),
    ...
    this.create('layout', 'Checkbox-Container'),
    this.create('layout', 'Divider'),
    this.create('layout', 'List', DemoMarkerType.Updated),
    {
      onclick: () => this.router.navigate(['components-overview/master-detail']),
    ...
    this.create('lookup', 'Lookup-Autocomplete'),
    this.create('lookup', 'Lookup-Combobox', DemoMarkerType.Updated),
