...
@Component({
  selector: 'checkbox-container-example',
  templateUrl: './checkbox-container-example.component.html',
  styleUrls: ['./checkbox-container-example.component.scss'],
...
export class CheckboxContainerExampleComponent {
