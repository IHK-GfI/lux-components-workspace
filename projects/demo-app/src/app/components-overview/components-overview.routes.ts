...
export const COMPONENT_OVERVIEW_ROUTES: Routes = [
  ...
  { path: 'master-detail', loadComponent: () => import('./master-detail-example/master-detail-example.component').then(m => m.MasterDetailExampleComponent) },
  {
    path: 'example', loadComponent: () => import('../example-base/example-base-root/example-root.component').then(m => m.ExampleRootComponent), children: [
      ...
      { path: 'autocomplete', loadComponent: () => import('./autocomplete-example/autocomplete-example.component').then(m => m.AutocompleteExampleComponent) },
      ...
      { path: 'chips', loadComponent: () => import('./chip-example/chip-example.component').then(m => m.ChipExampleComponent) },
      { path: 'datepicker', loadComponent: () => import('./datepicker-example/datepicker-example.component').then(m => m.DatepickerExampleComponent) },
      { path: 'datetimepicker', loadComponent: () => import('./datetimepicker-example/datetimepicker-example.component').then(m => m.DatetimepickerExampleComponent) },
      { path: 'timepicker', loadComponent: () => import('./timepicker-example/timepicker-example.component').then(m => m.TimepickerExampleComponent) },
      ...
      { path: 'radio-button', loadComponent: () => import('./radio-example/radio-example.component').then(m => m.RadioExampleComponent) },
      { path: 'select', loadComponent: () => import('./select-example/select-example.component').then(m => m.SelectExampleComponent) },
      { path: 'slider', loadComponent: () => import('./slider-example/slider-example.component').then(m => m.SliderExampleComponent) },
      ...
      { path: 'textarea', loadComponent: () => import('./textarea-example/textarea-example.component').then(m => m.TextareaExampleComponent) },
      ...
      { path: 'lookup-combobox', loadComponent: () => import('./lookup-examples/lookup-combobox-example/lookup-combobox-example.component').then(m => m.LookupComboboxExampleComponent) },
      { path: 'lookup-autocomplete', loadComponent: () => import('./lookup-examples/lookup-autocomplete-example/lookup-autocomplete-example.component').then(m => m.LookupAutocompleteExampleComponent) },
      ...
      { path: 'toggle', loadComponent: () => import('./toggle-example/toggle-example.component').then(m => m.ToggleExampleComponent) },
      ...
      { path: 'file-input', loadComponent: () => import('./file-example/file-input-example/file-input-example.component').then(m => m.FileInputExampleComponent) },
      ...
      { path: 'tile-ac', loadComponent: () => import('./tile-ac-example/tile-ac-example.component').then(m => m.TileAcExampleComponent) },
      { path: 'input', loadComponent: () => import('./input-example/input-example.component').then(m => m.InputExampleComponent) },
      { path: 'checkbox', loadComponent: () => import('./checkbox-example/checkbox-example.component').then(m => m.CheckboxExampleComponent) },
      { path: 'tile-overview', loadComponent: () => import('./tile-ac-example/overview-example/overview-example.component').then(m => m.OverviewExampleComponent) },
