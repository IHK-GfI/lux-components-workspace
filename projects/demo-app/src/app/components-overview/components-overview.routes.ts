...
export const COMPONENT_OVERVIEW_ROUTES: Routes = [
  ...
  { path: 'master-detail', loadComponent: () => import('./master-detail-authentic-example/master-detail-authentic-example.component').then(m => m.MasterDetailAuthenticExampleComponent) },
  {
    path: 'example', loadComponent: () => import('../example-base/example-base-root/example-root.component').then(m => m.ExampleRootComponent), children: [
      ...
      { path: 'autocomplete', loadComponent: () => import('./autocomplete-authentic-example/autocomplete-authentic-example.component').then(m => m.AutocompleteAuthenticExampleComponent) },
      ...
      { path: 'chips', loadComponent: () => import('./chip-authentic-example/chip-authentic-example.component').then(m => m.ChipAuthenticExampleComponent) },
      { path: 'datepicker', loadComponent: () => import('./datepicker-authentic-example/datepicker-authentic-example.component').then(m => m.DatepickerAuthenticExampleComponent) },
      { path: 'datetimepicker', loadComponent: () => import('./datetimepicker-authentic-example/datetimepicker-authentic-example.component').then(m => m.DatetimepickerAuthenticExampleComponent) },
      ...
      { path: 'radio-button', loadComponent: () => import('./radio-authentic-example/radio-authentic-example.component').then(m => m.RadioAuthenticExampleComponent) },
      { path: 'select', loadComponent: () => import('./select-authentic-example/select-authentic-example.component').then(m => m.SelectAuthenticExampleComponent) },
      { path: 'slider', loadComponent: () => import('./slider-authentic-example/slider-authentic-example.component').then(m => m.SliderAuthenticExampleComponent) },
      ...
      { path: 'textarea', loadComponent: () => import('./textarea-authentic-example/textarea-authentic-example.component').then(m => m.TextareaAuthenticExampleComponent) },
      ...
      { path: 'toggle', loadComponent: () => import('./toggle-authentic-example/toggle-authentic-example.component').then(m => m.ToggleAuthenticExampleComponent) },
      ...
      { path: 'file-input', loadComponent: () => import('./file-example/file-input-authentic-example/file-input-authentic-example.component').then(m => m.FileInputAuthenticExampleComponent) },
