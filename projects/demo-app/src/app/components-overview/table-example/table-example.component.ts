...
export class TableExampleComponent extends TableExampleBaseClass {
  ...
  loadData(simulateLargeSource: boolean) {
    const data = [
      ...
      { name: 'Öxygen', symbol: 'O', date: new Date(2019, 11, 24), disabled: false },
      { name: '', symbol: 'F', date: new Date(2020, 11, 24), disabled: false },
      { name: 'äeon', symbol: 'Ne', date: new Date(2020, 10, 24), disabled: false },
      ...
      { name: 'Dluminum', symbol: 'Al', date: new Date(2020, 11, 24), disabled: false },
      ...
      { name: 'otto', symbol: 'S', date: new Date(2020, 11, 24), disabled: false },
      { name: null, symbol: null, date: new Date(2020, 9, 24), disabled: false },
      { name: undefined, symbol: undefined, date: new Date(2020, 11, 24), disabled: false },
      { name: 'ß', symbol: 'ß', date: new Date(2020, 11, 24), disabled: false },
      { name: 123, symbol: 'ß', date: new Date(2020, 2, 28), disabled: false },
      { name: 'Ä', symbol: 'ä', date: new Date(2020, 2, 1), disabled: false },
      { name: 'Ü', symbol: 'ü', date: new Date(2020, 2, 10), disabled: false },
      { name: 'Ö', symbol: 'ö', date: new Date(2020, 11, 13), disabled: false },
      { name: 234.56, symbol: '2', date: new Date(2020, 11, 7), disabled: false },
      { name: '234,56', symbol: '3', date: new Date(2020, 11, 5), disabled: false },
      { name: '2.234,56', symbol: '4', date: new Date(2020, 11, 1), disabled: false },
      { name: 'AA', symbol: '', date: new Date(2020, 11, 2), disabled: false },
      { name: 'Élite', symbol: 'é', date: new Date(2020, 1, 1), disabled: false },
      { name: 'Egon', symbol: 'e', date: new Date(2020, 6, 30), disabled: false }
    ];
