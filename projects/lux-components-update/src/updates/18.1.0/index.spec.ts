...
import { update180100 } from './index';

describe('update180100', () => {
  ...
  beforeEach(async () => {
    ...
    context = runner.engine.createContext(runner.engine.createSchematic('update-18.1.0', runner.engine.createCollection(collectionPath)));
    ...
    it('Sollte die Abhängigkeiten aktualisieren', (done) => {
      ...
      callRule(update180100(testOptions), appTree, context).subscribe(
        () => {
          ...
          expect(getPackageJsonDependency(appTree, '@ihk-gfi/lux-components-theme').version).not.toEqual('18.0.0');
          expect(getPackageJsonDependency(appTree, '@ihk-gfi/lux-components-theme').version).toEqual('18.1.0');
