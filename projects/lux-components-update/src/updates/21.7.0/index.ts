...
export function update210700(options: Options, runNpmInstall = true): Rule {
  return (_tree: Tree, _context: SchematicContext) => {
    return chain([
      messageInfoRule(`Die LUX-Components werden auf die Version 21.7.0 aktualisiert...`),
      messageInfoRule(`Die Datei "package.json" wird angepasst...`),
      updateDep('@ihk-gfi/lux-components', '21.7.0', false),
      updateDep('@ihk-gfi/lux-components-theme', '21.7.0', false),
      ...
      messageSuccessRule(`Die LUX-Components wurden auf die Version 21.7.0 aktualisiert.`),
