...
import { update190700 } from './index';

describe('update190700', () => {
  ...
  beforeEach(async () => {
    ...
    context = runner.engine.createContext(runner.engine.createSchematic('update-19.7.0', runner.engine.createCollection(collectionPath)));
  ...
  describe('[Rule] update190700', () => {
    it('Sollte die Abhängigkeiten aktualisieren', (done) => {
      ...
      callRule(update190700(testOptions), appTree, context).subscribe(
        () => {
          expect(getPackageJsonDependency(appTree, '@ihk-gfi/lux-components').version).not.toEqual('19.1.0');
          expect(getPackageJsonDependency(appTree, '@ihk-gfi/lux-components').version).toEqual('19.7.0');
          done();
        },
