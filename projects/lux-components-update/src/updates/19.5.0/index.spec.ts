...
import { update190500 } from './index';
import { lastValueFrom } from 'rxjs';

describe('update190500', () => {
  ...
  beforeEach(async () => {
    ...
    context = runner.engine.createContext(runner.engine.createSchematic('update-19.5.0', runner.engine.createCollection(collectionPath)));
  ...
  describe('[Rule] update190500', () => {
    it('Sollte die Abhängigkeiten aktualisieren', async () => {
      ...
      await lastValueFrom(callRule(update190500(testOptions), appTree, context));
