...
export class LuxChipsComponent extends LuxFormComponentBase<string[] | null> implements AfterContentInit, AfterViewInit, OnDestroy {
  ...
  readonly luxChipComponents = contentChildren(LuxChipComponent);
  readonly luxChipGroupComponents = contentChildren(LuxChipGroupComponent);
  ...
  get chipComponents(): readonly LuxChipComponent[] {
    return this.luxChipComponents();
  }

  get chipGroupComponents(): readonly LuxChipGroupComponent[] {
