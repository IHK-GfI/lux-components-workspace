...
describe('LuxInputAcComponent', () => {
  ...
  describe('innerhalb eines Formulars', () => {
    ...
    describe('type="number"', () => {
      ...
      it('Sollte required sein', fakeAsync(() => {
        // Vorbedingungen testen
        fixture.detectChanges();
        const luxInput: LuxInputAcComponent = fixture.debugElement.query(By.css('#amount0')).componentInstance;
  ...
  describe('Pre- und Suffix', () => {
    ...
    it('Sollte sowohl Pre- als auch Suffix darstellen', fakeAsync(() => {
      // Vorbedingungen testen
      let suffix = fixture.debugElement.query(By.css('lux-input-ac-suffix'));
      let prefix = fixture.debugElement.query(By.css('lux-input-ac-prefix'));
      ...
      // Nachbedingungen prüfen
      suffix = fixture.debugElement.query(By.css('lux-input-ac-suffix'));
      prefix = fixture.debugElement.query(By.css('lux-input-ac-prefix'));
...
@Component({
  template: `
    <form [formGroup]="formGroup">
      ...
      <lux-input-ac [luxType]="fieldType" luxControlBinding="amount01" id="amount01"></lux-input-ac>
      <lux-input-ac [luxType]="fieldType" luxControlBinding="amount02" id="amount02"></lux-input-ac>
      <lux-input-ac [luxType]="fieldType" luxControlBinding="amount03" id="amount03"></lux-input-ac>
      <lux-input-ac [luxType]="fieldType" luxControlBinding="amount04" id="amount04"></lux-input-ac>
      <lux-input-ac [luxType]="fieldType" luxControlBinding="amount05" id="amount05"></lux-input-ac>
      <lux-input-ac [luxType]="fieldType" luxControlBinding="amount06" id="amount06"></lux-input-ac>
      <lux-input-ac [luxType]="fieldType" luxControlBinding="amount07" id="amount07"></lux-input-ac>
      <lux-input-ac [luxType]="fieldType" luxControlBinding="amount08" id="amount08"></lux-input-ac>
      <lux-input-ac [luxType]="fieldType" luxControlBinding="amount09" id="amount09"></lux-input-ac>
      <lux-input-ac [luxType]="fieldType" luxControlBinding="amount10" id="amount10"></lux-input-ac>
      <lux-input-ac [luxType]="fieldType" luxControlBinding="amount11" id="amount11"></lux-input-ac>
      <lux-input-ac [luxType]="fieldType" luxControlBinding="amount12" id="amount12"></lux-input-ac>
      <lux-input-ac [luxType]="fieldType" luxControlBinding="amount13" id="amount13"></lux-input-ac>
      <lux-input-ac [luxType]="fieldType" luxControlBinding="amount14" id="amount14"></lux-input-ac>
      <lux-input-ac [luxType]="fieldType" luxControlBinding="amount15" id="amount15"></lux-input-ac>
      <lux-input-ac [luxType]="fieldType" luxControlBinding="amount16" id="amount16"></lux-input-ac>
...
@Component({
  template: `
    <form [formGroup]="formGroup">
      <!-- Inputs vom Typ 'number' -->
      <lux-input-ac [luxType]="fieldType" luxControlBinding="amount0" id="amount0"></lux-input-ac>
      <lux-input-ac luxType="number" luxControlBinding="amount1" id="amount1"></lux-input-ac>
...
@Component({
  template: `
    <lux-input-ac luxLabel="amount0" luxPlaceholder="amount0">
      @if (showPrefix()) {
        <lux-input-ac-prefix>prefix</lux-input-ac-prefix>
      }
      @if (showSuffix()) {
        <lux-input-ac-suffix>suffix</lux-input-ac-suffix>
      }
    </lux-input-ac>
  `,
  changeDetection: ChangeDetectionStrategy.OnPush,
...
@Component({
  template: `
    <lux-input-ac [luxType]="type" luxLabel="Label" [luxHint]="hint" [luxDisabled]="disabled()" [luxMaxLength]="maxLength()">
    </lux-input-ac>
  `,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [LuxInputAcComponent]
