...
@Component({
  selector: 'lux-datetime-overlay-content, lux-datetime-overlay-content-ac',
...
export class LuxDatetimeOverlayContentComponent implements OnInit, AfterViewInit {
  readonly hoursInputComponent = viewChild.required<LuxInputComponent>('hoursInput');
  readonly minutesInputComponent = viewChild.required<LuxInputComponent>('minutesInput');
