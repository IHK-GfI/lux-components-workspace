...
**WICHTIG**: Mit der Umstellung auf 19.7.0 wird die temporäre Lösung mit der Property _useLocalStorageForComponentsAllowed_ in der [Config](config-v19) zu Gunsten eines Einwilligungskonzepts (siehe _lux-consent_) entfernt.
