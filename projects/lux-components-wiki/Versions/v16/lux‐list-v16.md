...
![Beispielbild LUX-List](https://raw.githubusercontent.com/wiki/IHK-GfI/lux-components/Versions/v16/lux‐list-v16-img.png)
...
Das LuxListItemIconComponent nimmt [lux-icon](lux‐icon-v16) und [lux-image](lux‐image-v16) entgegen und stellt diese rechts vom Titel dar.
...
| Name                       | Typ      | Beschreibung                      |
| -------------------------- | -------- | --------------------------------- |
| [lux-icon](lux‐icon-v16)   | Selector | Siehe [lux-icon](lux‐icon-v16).   |
| [lux-image](lux‐image-v16) | Selector | Siehe [lux-image](lux‐image-v16). |
...
![Beispielbild 01](https://raw.githubusercontent.com/wiki/IHK-GfI/lux-components/Versions/v16/lux‐list-v16-img-01.png)
...
![Beispielbild 02](https://raw.githubusercontent.com/wiki/IHK-GfI/lux-components/Versions/v16/lux‐list-v16-img-02.png)
