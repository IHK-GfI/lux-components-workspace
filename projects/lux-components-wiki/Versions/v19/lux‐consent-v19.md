...
export const appConsentProvider = {
  ...
  useFactory: () =\> ({
    cookieKey: 'meine-app-consent',
    impressumComponentLoader: () =\> import('./impressum/impressum.component').then((m) =\> m.ImpressumComponent),
    datenschutzComponentLoader: () =\> import('./dse/dse.component').then((m) =\> m.DseComponent),
    entries: [
      {
        ...
        duration: 'persistent',
        description: 'Speichert die Auswahl des App-Themes.'
      }
    ]
  })
};
