...
![Beispielbild LUX-Slider](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v19/lux‐slider-v19-img.png)
...
| luxShowThumbLabel      | boolean                | Bestimmt, ob beim Ziehen des Sliders ein Label mit dem aktuellen Wert angezeigt wird.                                                                                                                                                                                                                                      |
| luxValue               | number                 | Beinhaltet den aktuellen Wert des Sliders als Zahlenwert. Erlaubt auch Two-Way-Binding.                                                                                                                                                                                                                                    |
| luxMax                 | number                 | Bestimmt den Maximal-Wert des Sliders. Er muss größer als 0 und größer als `luxMin` sein.                                                                                                                                                                                                                                  |
| luxMin                 | number                 | Bestimmt den Minimal-Wert des Sliders. Er muss größer oder gleich 0 und kleiner als `luxMax` sein.                                                                                                                                                                                                                         |
...
![Beispielbild 01](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v19/lux‐slider-v19-img-01.png)
...
![Beispielbild 02](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v19/lux‐slider-v19-img-02.png)
...
![Beispielbild 03](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v19/lux‐slider-v19-img-03.png)
