...
![Beispielbild LUX-Table](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v19/lux‐table-v19-img.png)
...
| luxHttpDAO                      | ILuxTableHttpDao                      | Alternative zu `luxData`, welche den asynchronen Abruf von Daten pro Page ermöglicht. Dabei sollte die Funktion `loadData(conf: { page: number, pageSize: number, filter?: string, sort?: string, order?: string }): Observable<{ totalCount: number, items: any[] }>` implementiert werden. Das DAO kann das Interface `ILuxTableHttpDao` implementieren und die Funktion `loadData` kann den Rückgabetyp `Observable<ILuxTableHttpDaoStructure>` besitzen. |
...
| luxMinWidthPx                   | number                                | Bestimmt die Minimalbreite der Tabelle in PX, Voraussetzung dafür ist, dass `luxCalculateProportions` den Wert "true" besitzt.                                                                                                                                                                                                                                                                                                                               |
...
| luxMultiSelectOnlyCheckboxClick | boolean                               | Dieses Flag steuert, ob auch ein Klick auf die Zeile die Checkbox aktiviert oder ob ausschließlich ein Klick auf die Checkbox selbst die Auswahl ändert. Dies kann nützlich sein, wenn die Tabelle auch Formularelemente (z.B. Textfelder) enthält; dann wird bei einem Klick in das Textfeld nicht zusätzlich die Checkbox aktiviert. <br><br> Erfordert `luxMultiSelect = true`.                                                                           |
...
| luxColumnVisibilityStore        | ILuxTableColumnVisibilityStore        | Wenn das Property nicht gefüllt wird, werden die ausgeblendeten Spalten im Browserspeicher (siehe _luxColumnStorageKey_) abgelegt. Wird ein individueller Store angegeben, wird dieser verwendet.                                                                                                                                                                                                                                                            |
...
| Name            | Typ               | Beschreibung                        |
| --------------- | ----------------- | ----------------------------------- |
| filterComponent | LuxInputComponent | Die Komponente des Tabellenfilters. |
...
![Beispielbild 01](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v19/lux‐table-v19-img-01.png)
...
![Beispielbild 02](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v19/lux‐table-v19-img-02.png)
...
![Beispielbild 03](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v19/lux‐table-v19-img-03.png)
...
![Beispielbild 04](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v19/lux‐table-v19-img-04.png)
...
![Beispielbild 05](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v19/lux‐table-v19-img-05.png)
...
![Beispielbild 06](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v19/lux‐table-v19-img-06.png)
...
![Beispielbild 07](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v19/lux‐table-v19-img-07.png)
...
![Beispielbild 08](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v19/lux‐table-v19-img-08.png)
...
![Beispielbild 09-01](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v19/lux‐table-v19-img-09-01.png)

In der Media-Query "sm":
![Beispielbild 09-02](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v19/lux‐table-v19-img-09-02.png)
