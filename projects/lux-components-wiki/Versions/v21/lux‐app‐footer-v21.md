...
![Beispielbild LUX-App-Footer](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v21/lux‐app‐footer-v21-img.png)
...
| luxCenteredView        | boolean | Flag um den Inhalt des Headers auf eine Max-Width zu beschränken und bei großen Bildschirmen zentriert darzustellen, default = false. Empfehlung, diesen Wert über die config setzen. |
...
| getButtonInfoByCmd(cmd: string): string \| undefined                  | Gibt ein LuxAppFooterButtonInfo-Objekt aus dem Array buttonInfos anhand eines übergebenen CMD-Strings zurück. Wenn kein Objekt gefunden werden konnte, wird undefined zurückgegeben. |

### LuxAppFooterLinkService

Dieser Service bietet die Möglichkeit, linksbündig eine Reihe von `LuxLinkComponents` darzustellen. Der Service nimmt einzelne Objekte bzw. Arrays von `LuxAppFooterLinkInfo` entgegen.
...
![Beispielbild 01](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v21/lux‐app‐footer-v21-img-01.png)
...
![Verrutschter App-Footer](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v21/lux‐app‐footer-v21-img-03.png)