...
![Beispielbild LUX-Tenant-Logo](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v21/lux‐tenant‐logo-v21-img.png)
...
| Name                 | Typ                   | Beschreibung                                                       |
| -------------------- | --------------------- | ------------------------------------------------------------------ |
| luxTenantLogoClicked | EventEmitter \<Event> | Dieser Output-Emitter gibt das Click-Event des `lux-image` weiter. |

### Konfiguration

#### Logos mit der App ausliefern

Siehe [LUX-Components-Config](config-v21#logos-mit-der-app-ausliefern).
...
![Beispielbild 01](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v21/lux‐tenant‐logo-v21-img-01.png)
...
![Beispielbild 02](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v21/lux‐tenant‐logo-v21-img-02.png)

Ohne:

![Beispielbild 03](https://raw.githubusercontent.com/IHK-GfI/lux-components-workspace/main/projects/lux-components-wiki/Versions/v21/lux‐tenant‐logo-v21-img-03.png)
