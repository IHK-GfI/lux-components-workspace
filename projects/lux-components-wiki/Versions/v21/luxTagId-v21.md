...
Über das Flag `generateLuxTagIds` in der Konfiguration (siehe [Config](config-v21#luxcomponentsconfigparameters))
...
wenn das Flag `generateLuxTagIds` in der Konfiguration (siehe [Config](config-v21#luxcomponentsconfigparameters))
aktiviert ist.
